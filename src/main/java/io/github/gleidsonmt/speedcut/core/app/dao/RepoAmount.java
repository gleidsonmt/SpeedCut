 ...
 */
public class RepoAmount implements Repository<Amount>  {

    private final DaoAmount DAO_AMOUNT = new DaoAmount();

    @Override
    public AbstractDao<Amount> getDao() {
        return DAO_AMOUNT;
    }

    public void put(Amount amount) {
        try {
            DAO_AMOUNT.put(amount);
