 ...
 */
package io.github.gleidsonmt.speedcut.core.app.database;
...
public class DataConnection {
    ...
    private String  database        = "speed";
    private String  timeZone        = String.valueOf(TimeZone.getDefault().toZoneId());
    private String  url             = "jdbc:mysql://" + host + "/" + database + "?useUnicode=true&allowPublicKeyRetrieval=true&useSSL=false&characterEncoding=utf8&serverTimezone=" + timeZone;
    ...
    public void init() {
        ...
        } catch (IllegalAccessException | InstantiationException | ClassNotFoundException | SQLException | InvocationTargetException | NoSuchMethodException e) {
            e.printStackTrace();
//            init();
        }
    }
